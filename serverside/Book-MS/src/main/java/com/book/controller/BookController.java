...
public class BookController {
	...
	@GetMapping("searchBy/{category}/{authorName}/{price}/{publisher}")
	List<Books> filterBooks(@PathVariable String category, @PathVariable String authorName,
			@PathVariable Long price, @PathVariable String publisher){
				return bookService.filterBooks(category,authorName, price,publisher);
