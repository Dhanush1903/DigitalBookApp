...
//				.collect(Collectors.toList());
	...
	@Override
	public List<Books> filterBooks(String category, String authorName, Long price, String publisher) {
		// TODO Auto-generated method stub
//		List<Books> booklist=	bookRepository.findByCategoryAuthorNamePublisherPrice(category.name(), authorName, price, publisher);
